<div class="content-wrapper">
    ...
    <section class="content">
        <a href="<?php echo base_url() . 'dashboard/artikel'; ?>" class="btn btn-sm btnprimary">Kembali</a>
        <br />
        <br />
      <?php echo form_open_multipart('dashboard/artikel_aksi');?>
            <div class="row">
                <div class="col-lg-9">
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <br />
                                    <textarea class="formcontrol" id="editor" name="konten"> <?php echo set_value('konten'); ?> </textarea>
                                </div>
                            </div>
                        </div>
                    </div>
